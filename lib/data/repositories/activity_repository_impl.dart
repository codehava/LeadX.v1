...
class ActivityRepositoryImpl implements ActivityRepository {
  ...
  Future<Result<domain.Activity>> createActivity(
    ...
    try {
      ...
      final companion = db.ActivitiesCompanion.insert(
        ...
        keyPersonId: Value(dto.keyPersonId),
  ...
  Future<Result<domain.Activity>> rescheduleActivity(
    ...
    try {
      ...
      final newCompanion = db.ActivitiesCompanion.insert(
        ...
        keyPersonId: Value(existing.keyPersonId),
    ...
    try {
      ...
      final companions = remoteData.map((data) {
        ...
        return db.ActivitiesCompanion(
          ...
          keyPersonId: Value(data['key_person_id'] as String?),
  ...
  Map<String, dynamic> _createUpdateSyncPayload(db.Activity data) {
    return {
      ...
      'key_person_id': data.keyPersonId,
      'summary': data.summary,
      'notes': data.notes,
      'status': data.status,
