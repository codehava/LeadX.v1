  ...
  Future<void> _handleSave() async {
    ...
    try {
      ...
      if (widget.isEditing) {
        ...
        final updated = widget.keyPerson!.copyWith(
        ...
        await customerRepo.updateKeyPerson(updated);
      } else {
        // Create new key person
        final keyPerson = KeyPerson(
          id: '', // Will be generated by repository
          ownerId: widget.customerId,
          ownerType: KeyPersonOwnerType.customer,
          name: _nameController.text,
          position: _positionController.text.isEmpty ? null : _positionController.text,
          department: _departmentController.text.isEmpty ? null : _departmentController.text,
          phone: _phoneController.text.isEmpty ? null : _phoneController.text,
        ...
        await customerRepo.addKeyPerson(keyPerson);
      }
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              widget.isEditing
                  ? 'Key person berhasil diupdate'
                  : 'Key person berhasil ditambahkan',
            ),
          ),
        );
      }
